    ...
    <section className="py-20 bg-[#0A1628] px-4 sm:px-6 lg:px-8 pt-32">
      ...
      >
        ...
        <p className="text-lg text-[#8BA5C8] leading-relaxed">
          Comprehensive technology solutions crafted to solve your business challenges. 
          From web development to AI automation, we deliver excellence across every domain.
        </p>
      </motion.div>
    </section>
  );
