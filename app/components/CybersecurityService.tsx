...
export default function CybersecurityService() {
  const stack = ['Node.js', 'MongoDB', 'Python', 'Google Cybersecurity Framework', 'Encryption'];
  const deliverables = [
        ...
        >
          ...
          <div>
            ...
            <p className="text-[#8BA5C8] text-lg mb-6 leading-relaxed">
              Protect your digital assets with enterprise-grade security solutions. We provide 
              threat intelligence, secure development practices, and comprehensive vulnerability 
              assessments to keep your systems safe.
            </p>
