...
export default function AIAutomationService() {
  const stack = ['OpenAI API', 'GitHub Models', 'LangChain', 'Python', 'Next.js'];
  const deliverables = [
    'Intelligent AI chatbots & assistants',
    'Workflow automation pipelines',
    'LLM-powered tools & integrations',
        ...
        >
          ...
          <div className="md:order-2">
            ...
            <p className="text-[#8BA5C8] text-lg mb-6 leading-relaxed">
              Harness the power of artificial intelligence and automation to unlock new possibilities. 
              We build intelligent agents, workflow automation systems, and LLM integrations that 
